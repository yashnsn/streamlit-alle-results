...
root_path = "/Users/yaswanth/Downloads/combined images_upscaled_test_1024x1024_res_V1"
supp_path = '/Users/yaswanth/Downloads/combined images_upscaled_test_1024x1024'

all_folders = [i for i in os.listdir(f"{root_path}/") if not i.startswith('.') or not i.endswith('.csv')]
...
for ind_folder in all_folders:
    ...
    cols[1].write('upscaled - 1024x1024_res_V1')
    cols[1].image(img1)
    cols[2].write('upscaled - 1024x1024')
    cols[2].image(img2)
    st.divider()